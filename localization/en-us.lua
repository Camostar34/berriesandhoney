    ...
    descriptions = {
        ...
        Blind = {
            ...
            bl_smsn_grizzly = {
                name = "The Grizzly",
                text = {
                    "Destroys all consumables", "upon entering the Blind", "3x Base Size instead",
            ...
            bl_smsn_preserves = {
                name = "The Preserves",
                text = { "Discarded cards are", "returned to your deck" },
            },
        ...
        Edition = {
            e_smsn_redglaze = {
                ...
                text = { "{X:mult,C:white}X#1#{} Mult", "{C:attention}Removes{} edition", "after scoring" },
            },
            e_smsn_blueglaze = {
            ...
            e_smsn_brownglaze = {
                name = "Maple Glazed",
                text = { "{C:attention}+#1#{} hand size", "{C:attention}Removes{} edition", "after scoring or discard" },
            },
            e_smsn_yellowglaze = {
                name = "Lemon Poppy Glazed",
                text = {
                    "Earn {C:money}$#1#{} when", "played and scored", "{C:attention}Removes{} edition", "after scoring",
                },
            },

            e_smsn_orangeglaze = {
                name = "Honey Glazed",
                text = { "Return to hand", "after scoring", "{C:attention}Removes{} edition", "after scoring" },
            },
        ...
        Back = {
            ...
            b_smsn_rokuyo = {
                name = "Rokuyo Deck",
                text = {
                    "{C:green}Listed probabilities{} are", "{C:attention}doubled{} or {C:red}halved{}",
                    "depending on Ante", "and current {C:attention}Blind{}",
                },
            },
            b_smsn_evilegg = {
                name = "Evil Egg Deck",
                text = { "{C:attention}I{} laid this egg", "(Testing for jokers", "with easter egg art)" },
            },
            b_smsn_sticky = {
                name = "Sticky Deck",
                text = {
        ...
        Joker = {
            j_smsn_samson = {
                name = "Samson",
                text = { "{C:attention}Gold Cards{} return to", "your hand after scoring" },
            },
            ...
            j_smsn_grouphug = {
                name = "Group Hug!!",
                text = {
                    "{C:attention}OC{} and {C:attention}Guest{} Jokers", "from {C:attention}Berries and Honey{}",
            ...
            j_smsn_frostingknife = {
                name = "Frosting Knife",
                text = {
                    "Played {C:attention}Glazed{} cards have", "a {C:green}#1# in #2#{} chance to give",
                    "an {C:attention}adjacent{} card the", "same {C:attention}Glaze{} when scored",
                },
            },

            j_smsn_doubledipping = {
                name = "Double Dipping",
                text = { "Retrigger all", "{C:attention}Glazed{} cards" },
            },

            j_smsn_goldenoreo = {
                name = "Golden Oreo",
                text = { "Earn {C:money}$#1#{} when a", "{C:attention}Cookie{} card is scored" },
            },

            j_smsn_honeyslime = {
                name = "Honey Slime",
                text = {
                    "{C:green}#1# in #2#{} chance to add", "a {C:money}Gold Seal{} to first", "played card when a",
            ...
            j_smsn_goldenslime = {
                ...
                text = {
                    "Earn {C:money}$#1#{} when a", "{C:attention}consumable{} is used",
                    "{C:green}#2# in #3#{} chance to {C:red}disappear{}", "at the end of the round",
                },
            },
            ...
            j_smsn_sytoroonson = {
                ...
                text = {
                    "Retrigger all cards if", "hand contains a {C:attention}#1#{} of {C:hearts}Hearts{}",
            ...
            j_smsn_rivalshercule = {
                name = "ROA Hercule",
                text = {
                    "Gain {C:attention}+#1#{} hand size when", "a hand is played, {C:red}resets{}",
                    "at the end of the round", "{C:inactive}(Currently {C:attention}+#2#{C:inactive} hand size){}",
                },
            },
            ...
            j_smsn_rivalssamson = {
                name = "ROA Samson",
                text = {
                    "If hand contains one single {C:attention}Gold Card{},", "destroy it and turn {C:attention}#1#{}",
            ...
            j_smsn_bountifuljoker = {
                ...
                text = { "{C:attention}Berry Cards{} in your", "consumable area", "each give {C:red}+#1#{} Mult" },
            },

            j_smsn_strawbnyan = {
                name = "Strawbnyan",
                text = {
                    "Using a {C:dark_edition}Berry Card{}", "reduces the Blind requirement", "by {C:attention}#1#%{}",
                },
            },
            ...
            j_smsn_cherrybomb = {
                name = "Cherry Bomb",
                text = {
                    "{X:mult,C:white}X#1#{} Mult", "{C:green}#2# in #3#{} chance to destroy",
                    "played cards and {C:attention}self destruct{}",
                },
            },

            j_smsn_emmy = {
                name = { "Emmy Bunderbatch", "{s:0.75}Confectionery Witch" },
                text = {
                    "Gains {C:red}+#1#{} Mult and {C:blue}+#2#{} Chips", "when a {C:dark_edition}Berry Card{} is used",
            ...
            j_smsn_piggybank = {
                name = "Piggy Bank",
                text = { "Gain {C:money}$#1#{}", "when a {C:attention}Gold Card{}", "is destroyed" },
            },
            ...
            j_smsn_goldentooth = {
                name = "Golden Tooth",
                text = {
                    "{C:green}#1# in #2#{} chance to create", "a {C:attention}Gold Card{} when purchasing",
            ...
            j_smsn_hunnabee = {
                name = "Hunnabee",
                text = { "Create {C:attention}#1#{} Gold Cards", "when a Face card", "is destroyed" },
            },

            j_smsn_golddigger = {
                name = "Gold Digger",
                text = {
                    "Earn {C:money}$#1#{} when", "a {C:attention}#2#{} of {C:diamonds}#3#{}", "is scored",
                    "{C:inactive}(Rank changes every round){}",
                },
            },
            ...
            j_smsn_chamoille = {
                ...
                text = { "{C:attention}Gold Cards{} cannot", "be debuffed" },
            },

            j_smsn_honeybutterchips = {
                name = "Honey Butter Chips",
                text = {
                    "The first {C:attention}Gold Card{} scored", "gives {X:blue,C:white}X#1#{} Chips",
            ...
            j_smsn_fortunecookie = {
                name = "Fortune Cookie",
                text = {
                    "Earn {C:money}$#1#{} at the end of round", "Payout decreases by {C:red}$#2#{} when activated",
            ...
            j_smsn_gardener = {
                ...
                text = {
                    ...
                    "Every {C:attention}#1#{} {C:inactive}[#2#]{} hands played", "{C:inactive,s:0.8}(Must have room)",
                },
            },

            j_smsn_mintjams = {
                name = { "Mint Jams", "{s:0.75}By Casiopea" },
                text = {
                    "Scored cards without a {C:attention}modifier{} have a",
                    "{C:green}#1# in #2#{} chance to create a {C:dark_edition}Berry Card{}",
                    "Consumed if a modified card is scored", "{C:inactive,s:0.8}(Must have room)",
                },
            },
            ...
            j_smsn_pepperjelly = {
                ...
                text = {
                    "{C:dark_edition}Berry Cards{} held in your consumables", "give {X:mult,C:white}x#1#{} Mult",
                    "{C:green}#2# in #3#{} chance to destroy", "a berry when activated",
                },
            },
            ...
            j_smsn_razzby = {
                ...
                text = {
                    ...
                    "when a Joker is {C:attention}sold{} or {C:attention}destroyed{}",
                },
            },
            ...
            j_smsn_cookiejar = {
                name = "Cookie Jar",
                text = {
                    "Add a {C:attention}Cookie Card{} to your hand", "at the beginning of the round",
            ...
            j_smsn_uncommonrambley = {
                ...
                text = {
                    "Click to pay {C:money}$#1#{} and", "create a {C:dark_edition}Rambleberry{}",
                    "{C:inactive}(Usable once per Ante,{}", "{C:inactive}currently #2#){}",
                },
            },
            ...
            j_smsn_rarerambley = {
                name = "Retro Rambley",
                text = {
                    "Creates a {C:dark_edition}Rambleberry{}", "when any {C:attention}Booster{}",
                    "{C:attention}Pack{} is opened", "{C:inactive}(Must have room)",
                },
            },
            ...
            j_smsn_legendaryrambley = {
                ...
                text = {
                    "Has the combined effects of all", "{C:purple}Rambley{} Jokers from this mod",
            ...
            j_smsn_paddington = {
                ...
                text = {
                    "{C:white,X:mult}X#1#{} Mult, gains {C:white,X:mult}X#2#{} Mult", "when hand is played for",
                    "each card with {C:diamonds}Diamonds{}", "suit held in hand",
                },
            },
            ...
            j_smsn_marmalade = {
                ...
                text = {
                    "{C:diamonds}Diamond{} cards held in hand", "permanently gain {C:red}+#1#{} Mult",
                    "Eaten if a played hand leaves you", "with no {C:diamonds}Diamond{} cards in hand",
                },
            },

            j_smsn_bumbling = {
                name = "Bumbling Joker",
                text = { "{C:mult}+#1#{} Mult if played", "hand contains", "a {C:attention}Honeypot{}" },
            },

            j_smsn_stingy = {
                name = "Stingy Joker",
                text = { "{C:chips}+#1#{} Chips if played", "hand contains", "a {C:attention}Honeypot{}" },
            },

            j_smsn_colony = {
                name = "The Colony",
                text = { "{X:mult,C:white}X#1#{} Mult if played", "hand contains", "a {C:attention}Honeypot{}" },
            },

            j_smsn_meltingpot = {
                name = "Melting Pot",
                text = {
                    "{C:attention}Honeypot{} hands can be", "made with {C:money}Gold Seals{}",
            ...
            j_smsn_workerbee = {
                name = "Worker Bee",
                text = { "{C:attention}6{}s are considered", "{C:attention}Gold Cards{}" },
            },
            ...
            j_smsn_crystalized = {
                ...
                text = {
                    "{C:money}Gold Cards{} give {C:chips}+#1#{} Chips", "per {C:money}$#2#{} you have",
            ...
            j_smsn_bearclaws = {
                ...
                text = { "When a {C:attention}Glazed Card{}",
                    ...
                    "and permanently gain {C:money}$#1#{}",
                    "in sell value"
            ...
            j_smsn_teteatete = {
                name = { "tete-a-tete", "{s:0.75}By OSTER Project" },
                text = { "{C:attention}Pairs{} can be made with", "any 2 {C:attention}Face Cards{}" },
            },

            j_smsn_hothoney = {
                name = "Hot Honey",
                text = {
                    "Scored {C:attention}Gold Cards{} permanently gain {X:mult,C:white}x#1#{} Mult",
            ...
            j_smsn_boykisser = {
                name = "Boykisser",
                text = { "Scored {C:attention}Kings{} and {C:attention}Jacks{}", "permanently gain {C:red}+#1#{} Mult" },
            },
            ...
            j_smsn_strawberrygirl = {
                name = { "Strawberry Girl", "{s:0.75}By Odyssey Eurobeat" },
                text = { "Create a {C:dark_edition}Strawberry{}", "when a {C:hearts}Heart Flush{}", "is played" },
            },

            j_smsn_mycom = {
                name = { "MYCOM MAIM MARIONETTE", "{s:0.75}By Kidorikko" },
                text = {
                    "Gains {X:mult,C:white}x#1#{} when a hand is played", "containing an {C:attention}unscored{} card",
            ...
            j_smsn_bambi = {
                name = { "BAMBI", "{s:0.75}By STOMACH BOOK" },
                text = {
                    "Destroy the first card scored", "if a {C:dark_edition}Negative Berry Card{}",
                    "was consumed this hand", "{s:0.75,E:1,C:inactive}What a merry way to rot~!",

                },
            },

            j_smsn_robotface = {
                name = { "Robot Face", "{s:0.75}By Caravan Palace" },
                text = {
            ...
            j_smsn_beehive = {
                name = "Beehive",
                text = {
                    "Activated {C:attention}Gold Cards{} permanently gain {C:money}$#1#{}", "of held in hand value",
                    "at the end of the round",
                },
            },
            ...
            j_smsn_allberries = {
                ...
                text = {
                    "The shop is {C:attention}Guaranteed{}", "to contain a {C:dark_edition}Mega Picnic Pack{}",
            ...
            j_smsn_airfreshener = {
                name = "Air Freshener",
                text = {
                    "Create #1# {C:dark_edition}Berry Cards{}", " when {C:attention}Small Blind{}", "is selected",
                    "{C:inactive,s:0.8}(Must have room)",
                },
            },
            ...
            j_smsn_dieting = {
                name = "Dieting Joker",
                text = { "{C:blue}+#1#{} Chips per", "item in your", "consumable area" },
            },

            j_smsn_weightlossshake = {
                name = "Weight Loss Shake",
                text = {
                    "{C:green}+#1#{} to all", "listed probabilities,", "{C:red}-1{} when using",
            ...
            j_smsn_memory = {
                ...
                text = {
                    "Create a {C:dark_edition}Negative Berry Card{}", "when {C:attention}#1#{} or more face",
                    "cards are discarded",
                },
            },
            j_smsn_memory_active = {
                ...
                text = {
                    "Create a {C:dark_edition}Negative Berry Card{}", "when {C:attention}#1#{} or more face",
                    "cards are discarded", "{C:inactive,E:smsn_shaking}Why don't you remember her face?!?!?{}",
                },
            },
            ...
            j_smsn_twistedgarden = {
                name = "Twisted Garden",
                text = {
                    "All {C:dark_edition}Berry Cards{}", "added to your consumables",
            ...
            j_smsn_coughdrops = {
                ...
                text = {
                    "When round begins, add a random", "{C:attention}Gold{} playing card to your hand",
            ...
            j_smsn_chantilly = {
                name = "Chantilly Cake",
                text = {
                    "Gives {X:mult,C:white}xMult{} for", "number of unique", "{C:attention}Consumable types{}",
            ...
            j_smsn_fruitsando = {
                name = "Fruit Sando",
                text = {
                    "{C:dark_edition}Berry Cards{} held in your", "consumables give {X:chips,C:white}x#1#{} Chips",
                    "{C:green}#2# in #3#{} chance to be {C:attention}eaten{} when", "a berry is sold or activated",
                },
            },
            ...
            j_smsn_secondhelping = {
                name = "Second Helping",
                text = {
                    "{C:dark_edition}Berry Cards{} have a", "{C:green}#1# in #2#{} chance to",
            ...
            j_smsn_tamago = {
                name = "Tamago Sando",
                text = {
                    "{C:diamonds}Diamond{} suits held", "in hand give {C:money}$#1#{} each",
                    "{C:attention}Eaten{} if hand is played", "without holding any {C:diamonds}Diamond{} suits",
                },
            },
            ...
            j_smsn_grilledcheese = {
                name = "Grilled Cheese",
                text = {
                    "{C:spades}Spade{} suits held", "in hand give {C:red}+#1#{} Mult each",
                    "{C:attention}Eaten{} if hand is played", "without holding any {C:spades}Spade{} suits",
                },
            },
            ...
            j_smsn_clubsandwich = {
                name = "Club Sandwich",
                text = {
                    "{C:clubs}Club{} suits held", "in hand give {C:blue}+#1#{} Chips each",
                    "{C:attention}Eaten{} if hand is played", "without holding any {C:clubs}Club{} suits",
                },
            },
            ...
            j_smsn_ruben = {
                name = "Ruben Sandwich",
                text = {
                    "{C:hearts}Heart{} suits held", "in hand give {X:mult,C:white}x#1#{} Mult each",
                    "{C:attention}Eaten{} if hand is played", "without holding any {C:hearts}Heart{} suits",
                },
            },

            j_smsn_cannery = {
                name = "Cannery",
                text = { "Discarded cards have a", "{C:green}#1# in #2#{} chance to", "gain a {C:blue}Freshness Seal{}" },
            },

            j_smsn_cookiemonster = {
                name = "Cookie Monster",
                text = {
                    "{C:green}#3# in #4#{} chance to {C:red}destroy{}", "played {C:attention}Cookie{} cards",
                    "Gains {C:white,X:chips}X#1#{} Chips when a", "{C:attention}Cookie{} card is {C:red}destroyed{}",
            ...
            j_smsn_peanutbutter = {
                name = "Peanut Butter",
                text = { "Cards return to your hand after scoring", "Consumed after {C:attention}#1#{} hands" },
            },

            j_smsn_peoplepleaser = {
                name = "People Pleaser",
                text = { "Face cards gain random", "{C:attention}Glazes{} after scoring" },
            },
            ...
            j_smsn_fireblanket = {
                ...
                text = {
                    ...
                    "chance to give {X:mult,C:white}xMult{}", "for every unique suit in hand",
                },
            },
            ...
            j_smsn_mouse = {
                name = "Mouse Joker",
                text = {
                    "When you {C:red}discard{} a", "single {C:attention}Gold{} card, remove",
                    "its {C:attention}Enhancement{} and", "earn {C:attention}double{} its held", "in hand value",
                },
            },

            j_smsn_muffintray = {
                name = "Muffin Tray",
                text = { "Trigger all {C:attention}Bonus Cards{}", "and {C:attention}Mult Cards{}", "held in hand" },
            ...
            j_smsn_compost = {
                name = "Compost Bin",
                text = {
                    "This Joker gains {C:gold}$#1#{} of", "sell value every #2#", "{C:dark_edition}Berry Cards{} sold",
                },
            },

            j_smsn_manicface = {
                name = "Manic Face",
                text = { "Played {C:attention}face{} cards give", "{E:smsn_glitching,C:attention}someth{} when scored" },
            },

            j_smsn_berryboy = {
                name = "Berryboy Joker",
                text = {
                    "Creates a {C:purple}Death{} or", "{C:purple}Hanged Man{} Tarot when",
            ...
            j_smsn_sticker = {
                ...
                text = {
                    "Retrigger a played card with a {C:attention}seal{}", "per the amount of",
            ...
            j_smsn_hamtaro = {
                name = "Hamtaro",
                text = { "Earn {C:money}$#1#{} for", "every card {C:attention}held in hand{}",
                    "at the end of the round" },
            },

            j_smsn_stilton = {
                name = "Geronimo Stilton",
                text = { "Create a {C:purple}Tarot{} Card", "when a {C:money}Gold Seal{}", "is scored" },
            },

            j_smsn_pooh = {
                name = "Winnie The Pooh",
                text = { "Gain {C:money}$3{} when-", "Wait, where is he??", "{s:1.2,E:1}     Oh Bother...{}     " },
            },

            j_smsn_pipingbag = {
                name = "Piping Bag",
                text = {
                    "{V:1}#1#{} are shuffled", "to the {C:attention}top{} of your deck",
            ...
            j_smsn_cappuchino = {
                name = "Cappuccino", --HELLO!!!! IM CAPPUCHINO!!!!!!!!!!!!!!!!!!!!!!!!!
                text = {
            ...
            j_smsn_microplastics = {
                ...
                text = {
                    "Create 1 {C:dark_edition}Berry Card{} per", "{C:nflame_silicon}Silicon{} card owned",
                    "when a {C:attention}Boss Blind{} is selected", "{C:inactive,s:0.8}(Does not have to have room)",
                },
            },
            ...
            j_smsn_tasteful = {
                name = "Tasteful Joker",
                text = {
                    "{C:attention}+#1#{} hand size if", "a hand containing", "a {C:attention}#2#{}",
            ...
            j_smsn_rabbicksappy = {
                name = "Rabbick Sappy",
                text = { "Retrigger a {C:attention}Rouxles Karrd{}", "of a {C:clubs}Clubs{} suit" },
            },
            ...
            j_smsn_papersappy = {
                name = "Paper Sappy",
                text = {
                    "After {C:attention}#1#{} rounds,", "Sell this card to replenish",
                    "your {C:blue}Hands{} and {C:red}Discards{}", "and reduce Blind size by {C:attention}#2#%{}",
                    "{C:inactive}(#3# / #1#)",
                },
            },
            ...
            j_smsn_thegoteam = {
                name = { "Thunder, Lightning, Strike!!", "{s:0.75}By The Go! Team" },
                text = {
                    "{C:red}+#1#{} Mult and {C:money}$#2#{}", "if hand contains a {C:attention}Flash{}",
                    "and a {C:attention}Queen{}",
                },
            },

            j_smsn_kuchinohanabi = {
                name = { "Kuchinohanabi", "{s:0.75}By Hakushi Hasegawa" },
                text = { "Earn {C:money}$#1#{} if {C:attention}Flash{}", "was the only hand type", "played this round" },
            },

            j_smsn_gushers = {
                name = "Gushers",
                text = {
                    "Create a {C:dark_edition}Berry Card{}", "when a {C:attention}Flash{}", "is played",
            ...
            j_smsn_thunderstorm = {
                name = "Stormcloud",
                text = { "The first {C:attention}Flash{}", "of the round", "gives {X:chips,C:white}X#1#{} Chips" },
            },
            ...
            j_smsn_peapod = {
                ...
                text = {
                    {
                        "Steals a random {C:attention}Consumable{}", "at end of round, gains {C:blue}+#1#{} Chips",
                        "for every stolen consumable", "{C:inactive}(Currently{} {C:blue}+#2#{} {C:inactive}Chips){}",
                    },
                },
            },
            ...
            j_smsn_puddinhg = {
                ...
                text = {
                    {
                        "Earn {C:money}$#1#{} at the end of round", "per {C:dark_edition}Strawberry{} used this run",
            ...
            j_smsn_rose = {
                ...
                text = {
                    {
                        "{C:red}Debuffs{} all face cards", "{C:red}+#1#{} Mult for every face",
            ...
            j_smsn_cheese = {
                ...
                text = {
                    {
                        "If played hand contains a", "{C:attention}Gold Card{}, destroy it and upgrade",
            ...
            j_smsn_jadepenguin = {
                name = "Jade Penguin",
                text = {
                    "When {C:attention}#1#{} or more cards", "are {C:red}discarded{} at once,",
                    "{C:green}#2# in #3#{} chance to {C:red}destroy{}", "a discarded card and give {C:money}$#4#{}",
                },
            },
            ...
            j_smsn_ghost = {
                ...
                text = {
                    {
                        "If hand contains an", "{C:attention}unscoring{} card, {C:red}destroy{}",
                        "one and create a {C:attention}Boo Berry{}", "or a {C:attention}Franken Berry{}",
        ...
        Enhanced = {
            m_smsn_gingham = {
                name = "Gingham Card",
                text = { "{C:red}+#1#{} Mult per {C:attention}unique{}", "suit scored this hand" },
            },

            m_smsn_cookie = {
                name = "Cookie Card",
                text = {
                    "{C:blue}+#1#{} Chips and {C:red}+#2#{} Mult", "no rank or suit",
        ...
        berry = {
            ...
            c_smsn_cloudberry = {
                name = "Cloudberry",
                text = { "{C:money}$#1#{} at the end", "of the round", "{C:inactive,s:0.8}(Currently #2#)" },
            },

            c_smsn_blackberry = {
                name = "Blackberry",
                text = { "Draw {C:attention}#1#{} cards", "to your hand during a round" },
            },
            ...
            c_smsn_cherry = {
                name = "Cherry",
                text = {
                    "Creates the last {C:dark_edition}Berry{} card used", "{C:inactive,s:0.8}(Cannot copy Cherry)",
            ...
            c_smsn_preserves = {
                ...
                text = { "Increase the life of a {C:attention}Perishable{}", "Joker by {C:attention}#1#{} round" },
            },
