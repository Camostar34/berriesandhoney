    ...
    descriptions = {
                        Back = {
                            ...
                            b_smsn_sticky = {
                                ...
                                text = {
                                    ...
                                    "Start run with",
                                    "{C:attention}Samson{} and {C:attention}Honey Jar{}"
                                },
                            },
                            b_smsn_defunct = {
                                name = "Defunct Deck",
            ...
            sleeve_smsn_stickysleeve_alt = {
                ...
                text = {
                     ...
                     "halved when a {C:attnetion}Boss Blind{},",
                     "is defeated",
                     "Start with an",
                     "additional {C:attention}Beehive{}",
                },
            },
                    ...
                    "become {C:dark_edition}Polychrome{}"
                        ...
                        Joker = {
                            ...
                            j_smsn_peapod = {
                                ...
                                text = {
                                    ...
                                    {
                                        "{C:blue,s:0.7,E:2}Character by : Maridaka{}"
                                    }
                            },
                        },
                         ...
                         j_smsn_puddinhg = {
                                ...
                                text = {
                                    ...
                                    {
                                        "{C:blue,s:0.7,E:2}Character by : puddinhg{}"
                                    }
                            },
                        },
                         ...
                         j_smsn_shadow = {
                                ...
                                text = {
                                    ...
                                    {
                                        "{C:blue,s:0.7,E:2}Character by : octaandfnaf{}"
                                    }
                            },
                        },
                          j_smsn_rose = {
                           ...
                           j_smsn_pedro = {
                                ...
                                text = {
                                    ...
                                    {
                                        "{C:blue,s:0.7,E:2}Character by : Reaver of Souls{}"
                                    }
                            },
                        },
                         j_smsn_cozy = {
                        ...
                        j_smsn_astro = {
                                ...
                                text = {
                                    ...
                                    {
                                        "{C:blue,s:0.7,E:2}Character by : Astro{}"
                                    }
                            },
                        },
                         j_smsn_angel = {
                                ...
                                text = {
                                    ...
                                    {
                                        "{C:blue,s:0.7,E:2}Character by : FunnyToonDerg{}"
                                    }
                            },
                        },
                          j_smsn_gordon = {
