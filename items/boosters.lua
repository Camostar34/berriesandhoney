...
SMODS.Booster {
    key = "berrypack",
    weight = 1,
    kind = 'Berry', -- You can also use Arcana if you want it to belong to the vanilla kind
    cost = 4,
    pos = { x = 0, y = 0 },
    config = { extra = 3, choose = 1 },
    group_key = "k_berrypack", -- Delete this if you're using `group_name` in `loc_txt`
    draw_hand = false,
